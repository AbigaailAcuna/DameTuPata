...
<head>
  ...
  <!-- Navbar End -->
    ...
    <div class="carrusel">
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Piñita/piñita1.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Piñita/piñita2.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Piñita/piñita3.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Piñita/piñita4.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Piñita/piñita5.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Piñita/piñita6.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Piñita/piñita7.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Piñita/piñita8.jpg" class="d-block w-100" alt="...">
              </div>
            </div>
        ...
        <div class="info">
          <h1>Piñita</h1>
          <p>Ella es Piñita, un rescate de Dame tu Pata en Abril 2022.

            <br><br>Una bebuchita quien se encontraba abandonada en la calle a los 2 meses de edad, se rescató con severos problemas de piel, con Erlichia, con una patita lastimada.
            
            Piñita pasó varias semanas hospitalizada y luego en hogar temporal mientras le encontrábamos un hogar.
            
            Gracias a un ángel, ella fue adoptada y ahora vive felizmente en Canadá. Su adoptante nos envió un mensaje muy muy lindo, un testimonio desde el corazón, dando fe de la alegría que siente uno como persona al adoptar a un perrito quien sufrió mucho en las calles de El Salvador.
            
            <br><br>ADOPTAR SALVA VIDAS</p>
        </div>
    </div>
    <!--footer-->
