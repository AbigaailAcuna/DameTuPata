...
<head>
  ...
  <!-- Navbar End -->
    ...
    <div class="carrusel">
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Lolita/lolita1.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Lolita/lolita2.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Lolita/lolita3.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Lolita/lolita4.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Lolita/lolita5.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Lolita/lolita6.jpg" class="d-block w-100" alt="...">
              </div>
            </div>
        ...
        <div class="info">
          <h1>Lolita</h1>
          <p>ADOPCIONES DE ÉXITO, una cachorrita menos en la calle ✅

            Flor (una chica que vive en Metapan) comentó algo lindo que sucedió cuando Dame tu Pata publico la cachorrita que ella había rescatado en Septiembre 2022.
            
            Flor solicito la publicación en Dame tu Pata sobre una cachorrita que ella rescato; al instante la contactaron para adoptarla y meses después podemos compartir estas lindas fotografías de una ADOPCIÓN EXITOSA.
            
            <br><br>En esta labor de rescate y adopción animal se logra en trabajo en equipo, y esta es una linda historia que contar.
            
            <br><br>Gracias a la familia por adoptar a Lolita! 
            <br>Gracias a Flor por rescatar a Lolita de la calle; y tener la dedicación de cuidarla mientras era adoptada.
            
            <br><br>ADOPTAR SALVA VIDAS
            <br>RESCATAR SALVA VIDAS</p>
        </div>
    </div>
    <!--footer-->
