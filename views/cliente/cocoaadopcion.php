...
<div class="adopcion">
    ...
    <div class="carrusel">
        ...
        <div class="info">
          ...
          <p>Cocoa es una perrita fuerte, amorosa, valiente y sobre todo: es una sobreviviente de las crueles calles de El Salvador.
            <br><br>Cocoa te amamos ♥️ gracias por haber sido desde el día 1 una perrita nombre, quien a pesar de lo que sufrió en la calle, ella nos movía la Colita.</p>
        </div>
    </div>
    <br>
    <div class="form">
