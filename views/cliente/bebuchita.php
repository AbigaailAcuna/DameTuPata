...
<head>
  ...
  <!-- Navbar End -->
    ...
    <div class="carrusel">
        ...
        <div class="info">
          <h1>Bebuchita</h1>
          <p>Bebuchita es una de los cachorritos de Mama Gigi que fue adoptada, gracias Mamá Gigi por ser fuerte, cariñosa, social, amorosa. Gracias por dar el todo por el todo con tus 12 bebuchitos.

            Te admiramos Gigi, haber dado luz en plena calle a 12 hijitos, haber iniciado la crianza tu solita y mantenerlos con vida es admirable.
            
            <br><br>En Dame tu Pata estamos velando por ti, por tu salud  gracias por dejarnos cuidar a tus 12 hijitos, es momento de que cada uno de ellos encuentre su casita por siempre, es momento de que tú cuerpecito Gigi se recupere, de ayudarte y darte la mano que por tantos años te faltó.
            
            Gigi será esterilizada, y estará lista para encontrar una casita al igual que sus hijitos 🩷 Nuestras mamitas rescatadas también buscan un hogar por siempre.</p>
        </div>
    </div>
    <!--footer-->
