...
<head>
  ...
  <!-- Navbar End -->
    ...
    <div class="carrusel">
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Fiby/fiby1.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Fiby/fiby2.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Fiby/fiby3.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Fiby/fiby4.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Fiby/fiby5.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Fiby/fiby6.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Fiby/fiby7.jpg" class="d-block w-100" alt="...">
              </div>
            </div>
        ...
        <div class="info">
          <h1>Fiby</h1>
          <p>FIBY ADOPTADA! una de nuestras súper mamitas rescatadas junto a sus 6 hijitos, ha sido felizmente adoptada.

            Gracias Kevin por darle la oportunidad de una familia a Fiby luego de permanecer años en las calles de San Martín.
            
            Fiby se rescato en septiembre 2023 junto a sus cachorros recién nacidos. Ya todos fueron adoptados.
            
            Gracias de corazón a las personas que adoptan por amor, gracias por darle un espacio seguro a un perrito que sufrió y sintió mucho miedo viviendo en las calles de El Salvador.
            
            <br><br>Te amamos Fibycita linda.
            Tú hijitos están seguros y tú también
            Meta cumplida en Dame tu Pata</p>
        </div>
    </div>
    <!--footer-->
