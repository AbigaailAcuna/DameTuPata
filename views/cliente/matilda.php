  ...
  <!-- Navbar End -->
    ...
    <div class="carrusel">
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Matilda/matilda1.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Matilda/matilda2.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Matilda/matilda3.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Matilda/matilda4.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Matilda/matilda5.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Matilda/matilda6.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Matilda/matilda7.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Matilda/matilda8.jpg" class="d-block w-100" alt="...">
              </div>
            </div>
        ...
        <div class="info">
          <h1>Matilda</h1>
          <p>
            MATILDA ADOPTADA. COMPARTIR CON MUCHO AMOR OTRO LOGRO DE DAME TU PATA ~ Nuestra linda Matilda fue adoptada.<br><br>

Gracias siempre a quienes nos apoyan cuando Dame tu Pata decide ayudar a un perrito, gracias de corazón por su apoyo en donar su granito de arena para un caso estos son los lindos resultados de un trabajo en equipo, de ustedes también como donantes: Matilda fue recuperada de su desnutrición, de su infección en el utero donde se tuvo que hacer una esterilización de emergencia, ahora se encuentra sanita, ya con sus vacunas.

<br><br>Gracias a la mami de Matilda por decidir adoptarla.

<br>OTRO LOGRÓ MÁS PARA DAME TU PATA!!!!</p>
        </div>
    </div>
    <!--footer-->
