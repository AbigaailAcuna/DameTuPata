...
<head>
  ...
  <!-- Navbar End -->
    ...
    <div class="carrusel">
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Fiji/fiji1.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Fiji/fiji2.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Fiji/fiji3.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Fiji/fiji4.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Fiji/fiji5.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Fiji/fiji6.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Fiji/fiji7.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="http://localhost/DameTuPata/assets/img/Rescates-antes-despues/Fiji/fiji8.jpg" class="d-block w-100" alt="...">
              </div>
            </div>
        ...
        <div class="info">
          <h1>Fiji</h1>
          <p>Un 12 Septiembre 2021 te rescatamos de las crueles calles de Santiago Nonualco, con una patita fracturada, con heridas y desnutrición.

            Te recuperamos, te esterilízamos y publicados tu adopción en Dame tu Pata sin éxito alguno… te quedaste poco a poco en mi casita y te ganaste el corazón de todos.
            
            Desde entonces has demostrado ser una perrita espectacular, amorosa, feliz, dormilona, inteligente y expresiva haberte adoptado es una de las decisiones más lindas y perfectas de mi vida.
            
            <br><br>Te amamos Fifi linda!
            Adoptada por Julie, fundadora de Dame Tu Pata.</p>
        </div>
    </div>
    <!--footer-->
