    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                ...
                <p class="lead fw-normal text-white-50 mb-0">Fundación sin fines de lucro</p>
            </div>
        </div>
    </header>
    <!-- Section Productos-->
                ...
                ?>
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img src="<?php echo 'http://localhost/DameTuPata/assets/img/' . $dato["ImagenProducto"] ?>" class="card-img-top" alt="imágenes de productos" width="40px" />
                            <!-- Product details-->
